...
class Trainer(object):
    ...
    def iou_eval(self, dataset, train_step, buffer, model, ckpt_path):
        ...
        metrics = main_eval(
           ...
           self.config.train.backbone,         # vgg
           test_config,                        # thresholds
           evaluator,                          # IoU evaluator
           val_result_dir                      # where to save visualizations
       )
